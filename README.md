...
<p align="center">
  <samp>Sou um profissional com 18 anos de experiência em grandes empresas nacionais, atuando em Produção, Qualidade, Supply Chain e Finanças. Tenho formação técnica em Qualidade e Administração Financeira. Nos últimos anos, especializei-me em Cloud Computing e SRE, com certificações e experiência prática em AWS, Docker, Kubernetes, Terraform e Ansible.
  </samp>
  <br> <br>
...
<p align="center"> Windows, Linux, Python, Powershell, Docker, Kubernetes, Git, Github, Terraform, Ansible, Prometheus, Grafana, Datadog, Zabbix,  Jenkins, AWS.</p>
